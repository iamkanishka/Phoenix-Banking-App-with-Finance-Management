defmodule PhoenixBankingApp.Dwolla.Event  do
  @moduledoc """
  ...
  """
  @spec list(token, integer | nil, integer | nil) :: {:ok, [PhoenixBankingApp.Dwolla.Event .t]} | {:error, error}
  ...
  """
  @spec get(token, id) :: {:ok, PhoenixBankingApp.Dwolla.Event .t} | {:error, error}
  def get(token, id) do
